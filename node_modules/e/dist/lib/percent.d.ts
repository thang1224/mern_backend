 ...
 */
export declare function calcWhatPercent(partialValue: number, totalValue: number): number;
/**
 ...
 */
export declare function calcPercentOfNum(percent: number, valueToCalc: number): number;
/**
